...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2020 at 01:40 PM
...
(14, '2020_10_16_050205_create_play_counts_table', 6),
(15, '2020_10_16_045656_create_track_likes_table', 7);
...
--
-- Indexes for table `play_counts`
--
ALTER TABLE `play_counts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `play_counts_track_id_foreign` (`track_id`);
...
ALTER TABLE `track_likes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `track_likes_track_id_foreign` (`track_id`),
  ADD KEY `track_likes_user_id_foreign` (`user_id`);
...
--
-- AUTO_INCREMENT for table `play_counts`
--
ALTER TABLE `play_counts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `play_counts`
--
ALTER TABLE `play_counts`
  ADD CONSTRAINT `play_counts_track_id_foreign` FOREIGN KEY (`track_id`) REFERENCES `tracks` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `track_likes`
  ADD CONSTRAINT `track_likes_track_id_foreign` FOREIGN KEY (`track_id`) REFERENCES `tracks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `track_likes_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
